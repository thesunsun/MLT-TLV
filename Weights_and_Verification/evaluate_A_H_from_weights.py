...
SETTINGS = {'data_dir': '.', 'weights_dir': '.', 'models': ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'], 'batch_size': 512, 'seed': 35, 'split_seed': 35, 'val_ratio': 0.1, 'label_noise_rate': 0.012, 'fft_bins': 50, 'n_fft': 512, 'device': 'cuda:0' if torch.cuda.is_available() else 'cpu', 'comparison_tolerance': 1e-06}
